            ...
            <main className="container py-16">
                <article className="max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 mb-16">
                        <div className="glass-panel p-8 border-l-4 border-l-error">
                    ...
                    {/* CTA */}
                    <div className="text-center bg-[rgba(99,102,241,0.1)] p-12 rounded-2xl border border-[rgba(99,102,241,0.2)]">
                        <h2 className="text-3xl font-bold mb-6">Готовы интегрировать API?</h2>
                        <Link href="/#connect">
