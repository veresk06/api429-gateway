        ...
        <>
            ...
            <main className="container py-16 max-w-3xl">
                ...
                <div className="text-secondary leading-relaxed flex flex-col gap-6">
                    ...
                    <p>
                        Настоящее пользовательское соглашение регулирует использование сервиса api429.com. Искользуя сервис, вы соглашаетесь с данными условиями. api429.com является интерфейсом для доступа к API Google Gemini.
                    </p>
