...
export const metadata: Metadata = {
    title: 'Дешевый доступ к Gemini API | Скидки до 70% | GeminiGW',
...
export default function GeminiApiCheapPage() {
    return (
        <SeoPageTemplate
            ...
            problem="Использование передовых моделей (таких как Gemini-1.5-Pro) для больших объемов данных или миллионов запросов обходится дорого. Официальные прайсы съедают маржу продукта, вынуждая переходить на более слабые модели или ограничивать функционал для пользователей."
